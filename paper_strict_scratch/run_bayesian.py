...
def main() -> None:
    parser = argparse.ArgumentParser(description="Strict-paper Bayesian NAS-PINN runner")
    ...
    if args.save_dir:
        ...
        out_dir = Path("results") / "paper_strict_scratch" / args.equation / "bayesian" / stamp
