...
def search_nsga2(args, baseline_mod, baseline_script: Path, custom_nsga2, method_dir: Path, log_path: Path, env: Dict[str, str]) -> Dict:
    ...
    problem = Problem()
    algorithm = custom_nsga2(pop_size=args.pop_size)
